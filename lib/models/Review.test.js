...
describe('Review model', () => {
  ...
  it('review limit max', () => {
    const review = new Review({
      review: 'qmpudxnfsmteoijnjebpzqlqbasiclrkpocilikcmatydfkcfomhvshznvqogusmtesknrkcpyojkpzsahwhacglkuqzbtvpbelehrivbcilkuhebbobopaoxqtkkqaxtahczpcvlsqrkohxeweezjbnkcvewrxhnnjruw'
    });
    const { errors } = review.validateSync();
    expect(errors.review.message).toEqual('Path `review` (`qmpudxnfsmteoijnjebpzqlqbasiclrkpocilikcmatydfkcfomhvshznvqogusmtesknrkcpyojkpzsahwhacglkuqzbtvpbelehrivbcilkuhebbobopaoxqtkkqaxtahczpcvlsqrkohxeweezjbnkcvewrxhnnjruw`) is longer than the maximum allowed length (140).');
  });
});
